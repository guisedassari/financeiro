...
(function (a) {
    ...
    var f = {
        ...
        var m = b.scrollTop(), w = e.height(), v = w - a, o = (m > v) ? v - m : 0;
        for (var r = 0, p = k.length; r < p; r++) {
            var x = k[r], n = x.stickyWrapper.offset().top, t = n - x.topSpacing - o;
        ...
        init: function (l) {
            ...
            return this.each(function () {
                ...
                var q = o.parent();
                if (m.center) {
                    q.css({width: o.outerWidth(), marginLeft: "auto", marginRight: "auto"})
                }
